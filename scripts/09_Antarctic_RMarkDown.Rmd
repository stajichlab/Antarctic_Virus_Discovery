...
host_plot + amg_general  +  
  plot_annotation(tag_levels = "A") 

ggsave(filename = 'plots/exploratory/art_virus_host_amg.pdf', plot = last_plot(), device = 'pdf', width = 10, height = 6, dpi = 300)
...
# Figure 1
(ntwk.vir + e_tax ) / ( ntwk.hab.vir.hq + a_hab_seq ) / (host_plot + amg_general) + plot_annotation(tag_levels = "A") 
