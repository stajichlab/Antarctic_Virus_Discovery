...
# Figure 1
( ntwk.hab.vir.hq + a_hab_seq ) / (ntwk.vir + e_tax ) / (host_plot + amg_general) + plot_annotation(tag_levels = "A") 
...
grouped <- group_by(df_ps.RA.filt, Site.name...8, ClusterStatus, Phylum, Class, Order, Family, VCStatus, OTU)
...
plot_s = ggplot(vOTU_avgs_grouped, aes(x = Site.name...8, y = (mean), fill = Family2)) + 
